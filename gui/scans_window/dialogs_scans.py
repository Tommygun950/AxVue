...
class AddScanDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        1. Establish a QVBoxLayout with the following:
            a. Establish a QHBoxLayout for the scan name seciton with the following:
            ...
            b. Establish a QHBoxLayout for the filepath section with the following:
                1. A QLabel with the text "File Path: ".
                2. An optional QLineEdit if users want to type in the file path.
                3. A QPushButton called "Browse" so the user can select the file.
                4. Call the browse_file function when the user clicks the "Browse" button.
            ...
            c. Establish a QHBoxLayout for the buttons with the following: 
                ...
                4. If Cancel is clicked, close dialog and return rejected status.
    ...
    def browse_file(self):
        ...
        This function should:
        1. Open a modal file dialog titled "Select File" that filters for CSV files (*.csv) and all files.
        2. Retrieve the selected file's path from the dialog.
        3. If a file is selected, update the file path QLineEdit (self.file_path_edit) with the selected file path.
        """
...
class EditScanDialog(QDialog):
    """
    Dialog for editing an existing scan with a name, file path, and cache setting.
    """
    def __init__(self, scan_id, scan_name, file_path, cache_enabled, parent=None):
        """
    ...
    def setup_ui(self):
        ...
        This function should:
        1. Establish a QVBoxLayout with the following:
            a. Establish a QHBoxLayout for the scan name section with the following:
                1. A QLabel with the text "Scan Name:".
            ...
            b. Establish a QHBoxLayout for the filepath section with the following:
                ...
                3. A QPushButton called "Browse" so the user can select a new file.
                4. Call the browse_file function when the user clicks the "Browse" button.
                5. Add the label, line edit, and button to the QHBoxLayout.
                6. Add QHBoxLayout to the QVBoxLayout.
            c. Establish a QHBoxLayout for the cache section with the following:
                ...
                4. Call the toggle_cache function when the user clicks the button.
...
class GeneralErrorDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        4. Create a QPushButton labeled "OK" that closes the dialog when clicked.
        """
